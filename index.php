...
<body id="home">
    ...
    <div class="showcase">
       ...
       <div class="navbar-bottom">
            <a href="#" class="brand-left">নির্মল BHOOMI</a>
            <ul class="menu-right">
                ...
                <li><a href="register.php">AI TOOL</a></li>
        ...
        <div class="wrapper">
            <div class="items">
                ...
                <div class="item">
                    ...
                    <a href="register.php">click here to use</a>
                </div>
                <div class="item">
    ...
    <section id="teams" class="teams bg-light py-3">
        ...
        <p class="text-center">We help you  to see the world differently<br>and guide you to maintain the balance of nature </p>
        <div class="wrapper">
    ...
    <section id="contact" class="contact bg-secondary py-3">
        ...
        <div class="wrapper">
            <form class="text-center" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                ...
                <button class="button" name="sendmessage">Submit</button>
            </form>
        </div>
    </section>
    ...
    if(isset($_POST['sendmessage'])){
        ...
        $subject = "User problems on Nirmal Bhoomi";
        $body = "Hi Nirmal Bhoomi Team,\n
        I am $name.\n
        My problem is: $message.\n
        My email is: $email.";

        $recievedto = "nirmalbhumireciever@gmail.com";
        $headers = "From: nirmalbhumisender@gmail.com";
        $send_mail = mail($recievedto, $subject, $body, $headers);
        ...
        if($send_mail){
            ...
            ?>
            <script>
                alert("Sorry, we can not recieve your problem due to server error!");
            </script>
            <?php
        }
    }
